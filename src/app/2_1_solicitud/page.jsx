  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <ItemLista>
            <span className="font-bold">Fotocopia DNI por ambas caras.</span>
          </ItemLista>
          ...
          <ItemLista>
            <span className="font-bold">Impreso 046 </span> (se debe enviar el ejemplar para la administración y también el ejemplar para el interesado, que se devolverá sellado por el centro como resguardo del título).
          </ItemLista>

          <div className="flex flex-col gap-4 bg-blue-200 p-8 rounded-3xl shadow-lg shadow-slate-300 mt-8">
            <p>
